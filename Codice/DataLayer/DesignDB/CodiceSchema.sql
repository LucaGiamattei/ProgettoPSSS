...
CREATE TABLE IF NOT EXISTS `prova2`.`utente` (
  ...
  `Curriculum` VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `prova2`.`lezione` (
  ...
  `DescrizioneLezione` VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `prova2`.`fasciaoraria` (
  ...
  `Visibile` INT(11) NOT NULL DEFAULT '0',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prova2`.`catalogolezioni` (`idLezione` INT, `NomeLezione` INT, `MediaScoreLezione` INT, `NMaxStudenti` INT, `DataLezione` INT, `OrarioInizioLezione` INT, `OrarioFineLezione` INT, `prezzo` INT, `visibile` INT, `Utente_idUtente` INT, `Topic_idTopic` INT, `idFasciaOraria` INT);
...
USE `prova2`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `prova2`.`catalogolezioni` AS select `prova2`.`lezione`.`idLezione` AS `idLezione`,`prova2`.`lezione`.`NomeLezione` AS `NomeLezione`,`prova2`.`lezione`.`MediaScoreLezione` AS `MediaScoreLezione`,`prova2`.`lezione`.`NMaxStudenti` AS `NMaxStudenti`,`prova2`.`fasciaoraria`.`DataLezione` AS `DataLezione`,`prova2`.`fasciaoraria`.`OrarioInizioLezione` AS `OrarioInizioLezione`,`prova2`.`fasciaoraria`.`OrarioFineLezione` AS `OrarioFineLezione`,`prova2`.`lezione`.`prezzo` AS `prezzo`,`prova2`.`fasciaoraria`.`Visibile` AS `visibile`,`prova2`.`lezione`.`Utente_idUtente` AS `Utente_idUtente`,`prova2`.`lezione`.`Topic_idTopic` AS `Topic_idTopic`,`prova2`.`fasciaoraria`.`idFasciaOraria` AS `idFasciaOraria` from (`prova2`.`lezione` join `prova2`.`fasciaoraria` on(((`prova2`.`lezione`.`idLezione` = `prova2`.`fasciaoraria`.`Lezione_idLezione`) and (`prova2`.`lezione`.`Utente_idUtente` = `prova2`.`fasciaoraria`.`Lezione_Utente_idUtente`)))) where ((`prova2`.`fasciaoraria`.`DataLezione` > curdate()) or ((`prova2`.`fasciaoraria`.`DataLezione` = curdate()) and (`prova2`.`fasciaoraria`.`OrarioInizioLezione` >= curtime())));
