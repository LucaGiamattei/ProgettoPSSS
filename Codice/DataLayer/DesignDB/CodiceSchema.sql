...
USE `prova2`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `prova2`.`catalogolezioni` AS select `prova2`.`lezione`.`idLezione` AS `idLezione`,`prova2`.`lezione`.`NomeLezione` AS `NomeLezione`,`prova2`.`lezione`.`MediaScoreLezione` AS `MediaScoreLezione`,`prova2`.`lezione`.`NMaxStudenti` AS `NMaxStudenti`,`prova2`.`fasciaoraria`.`DataLezione` AS `DataLezione`,`prova2`.`fasciaoraria`.`OrarioInizioLezione` AS `OrarioInizioLezione`,`prova2`.`fasciaoraria`.`OrarioFineLezione` AS `OrarioFineLezione`,`prova2`.`fasciaoraria`.`prezzo` AS `prezzo`,`prova2`.`fasciaoraria`.`Visibile` AS `visibile`,`prova2`.`lezione`.`Utente_idUtente` AS `Utente_idUtente`,`prova2`.`lezione`.`Topic_idTopic` AS `Topic_idTopic`,`prova2`.`fasciaoraria`.`idFasciaOraria` AS `idFasciaOraria` from (`prova2`.`lezione` join `prova2`.`fasciaoraria` on(((`prova2`.`lezione`.`idLezione` = `prova2`.`fasciaoraria`.`Lezione_idLezione`) and (`prova2`.`lezione`.`Utente_idUtente` = `prova2`.`fasciaoraria`.`Lezione_Utente_idUtente`)))) where ((`prova2`.`fasciaoraria`.`DataLezione` > curdate()) or ((`prova2`.`fasciaoraria`.`DataLezione` = curdate()) and (`prova2`.`fasciaoraria`.`OrarioInizioLezione` >= curtime())));
